...
<body class="min-h-screen flex flex-col bg-gradient-to-b from-green-400 to-green-100 font-sans">
  ...
  {{-- Judul --}}
  <h2 class="text-3xl font-bold text-center text-white drop-shadow-md tracking-wide mt-8">
    SISTEM PENGGAJIAN KARYAWAN
  </h2>

  {{-- Main Content --}}
  <main class="px-6 md:px-24 mt-4 mb-8">
    <div class="mx-auto max-w-7xl grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
      ...
      <div class="max-w-xl">
        <p class="text-lg text-black">
          ...
          {{-- nanti ini bisa diganti pakai auth: {{ auth()->user()->name }} --}}
          <span class="font-semibold underline">Admin !</span>
        </p>
        ...
        <div class="mt-6 flex flex-wrap gap-3">
          {{-- nanti kalau sudah ada route resource, bisa pakai route('karyawan.index') --}}
          <a href="{{ url('/karyawan') }}"
      ...
      <div class="flex justify-center md:justify-end">
        {{-- simpan gambar di public/assets/dashboard-illustration.png --}}
